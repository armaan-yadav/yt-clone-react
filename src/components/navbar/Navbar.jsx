  ...
  return (
    <nav className="bg-black h-[56px] w-full  text-white">
      {showInput ? (
        <div className="h-full w-full bg-[#3F3F3F] flex items-center px-2">
          ...
          >
            <input
              ...
              placeholder="Search"
              autoFocus
              className="outline-none p-[5px] px-3 bg-transparent   sm:w-[400px] w-full"
            />
        ...
        <div className="h-full w-full grid grid-flow-col items-center  justify-between px-2 sm:px-5 ">
          <div className="flex items-center gap-3">
            ...
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-7 h-7 float-left hover:bg-[#f1f1f162] duration-200 rounded-full cursor-pointer"
              onClick={() => {
            ...
            <div className="w-[100px] ">
              <Link to={"/"}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  id="yt-logo-red-updated-svg_yt18"
                  className="external-icon"
                  viewBox="0 0 97 20"
                  focusable="false"
                >
                  <svg
                    id="yt-logo-red-updated_yt18"
                    viewBox="0 0 97 20"
                  ...
                  >
                    ...
                    <g id="youtube-red-paths_yt18" fill="white">
          ...
          >
            <input
              ...
              onChange={(e) => setSearchValue(e.target.value)}
              placeholder="Search"
              className="outline-none p-[5px] border-[1px] border-[rgba(248,248,248,0.4)] rounded-l-full border-r-0 px-3 bg-[#121212] sm:w-[400px] "
            />
            <button className="bg-[#3F3F3F] rounded-r-full px-3 border-[1px] border-[rgba(248,248,248,0.4)] border-l-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
