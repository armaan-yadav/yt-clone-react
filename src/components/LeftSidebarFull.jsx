...
const LeftSidebarFull = () => {
  ...
  return (
    <div
      className={`w-[170px] h-[100vh] bg-black text-white flex flex-col gap-5 items-center justify-start absolute top-0 duration-300 ease-in-out  ${
...
export default LeftSidebarFull;
